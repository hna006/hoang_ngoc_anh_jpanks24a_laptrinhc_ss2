...
int main() {
    ...
    int consumption;
    long totalAmount = 0;
    printf("Nhap chi so công to dien dau thang: ");
    scanf("%d", &oldIndex);
    printf("Nhap chi so công to dien cuoi thang: ");
    scanf("%d", &newIndex);
    ...
    printf("Luong dien tiêu thu trong thang: %d kWh\n", consumption);
    if (consumption <= 50) {
    ...
    printf("So tien dien phai tra la: %ld VND\n", totalAmount);
    return 0;
}
